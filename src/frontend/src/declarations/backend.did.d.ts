...
export type Category = { 'Arts' : null } |
  { 'Commerce' : null } |
  { 'Science' : null };
...
export type Level = { 'Postgraduate' : null } |
  { 'Undergraduate' : null } |
  { 'Doctoral' : null };
export interface StudyMaterial { 'title' : string, 'file' : ExternalBlob }
